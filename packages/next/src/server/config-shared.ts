...
export interface ExperimentalConfig {
   ...
   *
   * 'window'  → UMD globals. Developer loads <script src> UMDs in layout.tsx
   *             before framework chunks execute.
   * 'module'  → ESM imports. Developer adds <script type="importmap"> as first
   *             child of <head> mapping react/react-dom to module URLs.
   */
